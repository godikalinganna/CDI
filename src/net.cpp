...
static CSemacdi* semOutbound = NULL;
...
void static ProcessOneShot()
{
    ...
    CAddress addr;
    CSemacdiGrant grant(*semOutbound, true);
    if (grant) {
...
void ThreadOpenConnections()
{
    ...
    while (true) {
        ...
        CSemacdiGrant grant(*semOutbound);
        boost::this_thread::interruption_point();
...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemacdiGrant* grantOutbound, const char* pszDest, bool fOneShot)
{
    //
...
void StartNode(boost::thread_group& threadGroup)
{
    ...
    if (semOutbound == NULL) {
        ...
        semOutbound = new CSemacdi(nMaxOutbound);
    }
