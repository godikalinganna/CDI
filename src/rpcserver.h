...
extern json_spirit::Value walletpasscdiase(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value walletpasscdiasechange(const json_spirit::Array& params, bool fHelp);
