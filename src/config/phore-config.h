/* src/config/cdi-config.h.  Generated from cdi-config.h.in by configure.  */
/* src/config/cdi-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.cdi.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CDI Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CDI Core 1.2.2"
